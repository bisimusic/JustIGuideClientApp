...
const Services = ({}: ServicesProps) => (
    <div className="">
        <div className="mb-4">
            I’m JustiGuide - a comprehensive and roburst platform for users navigating
            the legal landscape. We offers a wide range of
            advanced features to simplify complex legal procedures and make them
            more efficient. With JustiGuide,you can expect the following capabilities:
        </div>
